...
echo ""
echo " Next steps:"
echo "   1. Create .env with these runtime values:"
echo "        FOUNDRY_PROJECT_ENDPOINT=${PROJECT_ENDPOINT}"
echo "        MODEL_DEPLOYMENT_NAME=${MODEL_DEPLOYMENT_NAME}"
echo "        AZURE_REGION=${LOCATION}"
echo "        AGENT_NAME=logs-analysis-agent"
echo "        SOURCE_SKILL_PATHS=source/skills/web-logs-analysis/SKILL.md,source/skills/k8s-logs-analysis/SKILL.md"
echo "        FOUNDRY_SKILL_NAMES=web-logs-analysis,k8s-logs-analysis"
echo "        FOUNDRY_TOOLBOX_NAME=logs-analysis-toolbox"
echo ""
